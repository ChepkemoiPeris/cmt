...
//    Route::post('org-chart-range', ['as' => 'post.org.chart', 'uses' => 'Agent\helpdesk\OrganizationController@orgChartData']);
        ...
        Route::get('get-esclation', ['as' => 'esclation.matrix', 'uses' => 'Agent\helpdesk\DashboardController@getEsclation']);   
        Route::post('create-service', ['as' => 'create.service', 'uses' => 'Agent\helpdesk\DashboardController@saveService']);
        Route::post('create-service-issue', ['as' => 'service.issue', 'uses' => 'Agent\helpdesk\DashboardController@saveServiceIssue']);
         Route::post('create-esclation-data', ['as' => 'create.esclation', 'uses' => 'Agent\helpdesk\DashboardController@saveEsclationMatrix']);

        
        Route::post('get-companyregion', ['as' => 'getRegion', 'uses' => 'Agent\helpdesk\DashboardController@getCompanyRegionByAjax']);
        Route::post('del-serviceissue', ['as' => 'del_serviceissue', 'uses' => 'Agent\helpdesk\DashboardController@deleteServiceIssue']);

          Route::get('dels-service', ['as' => 'delete_service', 'uses' => 'Agent\helpdesk\DashboardController@deleteService']);
        ...
        Route::get('report', ['as' => 'report.index', 'uses' => 'Agent\helpdesk\ReportController@index']); /* To show 

        dashboard pages */
        Route::get('reports', ['as' => 'reports.export', 'uses' => 'Agent\helpdesk\ReportController@export']); /* To show 
        ...
        Route::post('master-dump-xlsx', ['as' => 'master_dump_report', 'uses' => 'Agent\helpdesk\ReportController@masterDumpReport']);
         Route::post('generate-Report', ['as' => 'report_excel', 'uses' => 'Agent\helpdesk\ReportController@generateReport']);
...
/*         // Route for Esclation Matrix
        Route::get('get-esclation', ['as' => 'esclation.matrix', 'uses' => 'Agent\helpdesk\EsclationController@index']);  */      
...
//    });
    ...
    // for testing
    // Route::get('create-ticket-test', ['as' => 'form', 'uses' => 'Client\helpdesk\FormController@democreateticket']); //getform for test
     //for testing end       
...
//testing ckeditor
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::post('/ticket/inprocessticket/{id}', ['as' => 'ticket.inprocess', 'uses' => 'Agent\helpdesk\TicketController@inprogress']); /*  Get Ticket Inprogress */
        Route::get('/ticket/reassign/{id}/{ticketid}', ['as' => 'ticket.reassign', 'uses' => 'Agent\helpdesk\TicketController@reassign']);
        Route::get('/ticket/reassignform/{id}', ['as' => 'ticket.reassignform', 'uses' => 'Agent\helpdesk\TicketController@reassignForm']);
...
//    Route::get('/reportdata', 'HomeController@pushdata');
    ...
    Route::post('rolechangeagent1/{id}', ['as' => 'user.post.rolechangeagent1',  'uses' =>'Agent\helpdesk\UserController@changeRoleAgent1']);  
...
Route::get('get-service', ['as' => 'getService', 'uses' => 'Client\helpdesk\FormController@getServiceByAjax']);
Route::get('get-patient-type', ['as' => 'getPatientType', 'uses' => 'Client\helpdesk\FormController@getServiceTypeByAjax']);