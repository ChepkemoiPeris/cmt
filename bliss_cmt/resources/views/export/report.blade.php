@php
   ...
   @endphp
    ...
    <table style="background-color: #18479D;color:#FFFFFF">
        ...
        <tr> <td>{{$title}}</td><td></td><td></td><td>Run Date:{{$date}}</td><td></td><td>Time:{{$time}}</td><td></td></tr>
       ...
       <tr><td>{{$column_name}}</td><td>Status</td><td> 0-7 Days</td><td>7-15 Days</td><td>16-30 Days</td><td>>30 Days</td><td>Total Issues</td></tr>
    </table>
    ...
    <tr>
    <td rowspan="5">{{$row->service_name}}</td>
  ...
  @endforeach
   ...
   <tr>
    <td><strong>Grand Total</strong></td>  <td></td> <td><strong>{{$count7daysTotal}}</strong></td> <td><strong>{{$count7_15daysTotal}}</strong></td><td><strong>{{$count16_30daysTotal}}</strong></td>
    <td><strong>{{$countgreater_30daysTotal}}</strong></td><td><strong>{{$grandtotal}}</strong></td>
   </tr>
