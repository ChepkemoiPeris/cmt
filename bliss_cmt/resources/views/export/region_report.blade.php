@php
   ...
   @endphp
    ...
    ?> 
     ...
     <table style="background-color: #18479D;color:#FFFFFF">
       ...
       <tr><td>Region</td><td>Status</td><td> 0-7 Days</td><td>7-15 Days</td><td>16-30 Days</td><td>>30 Days</td><td>Total Issues</td></tr>
    </table>
  ...
  @endforeach
    ...
    <tr>
    <td><strong>Inprogress</strong> </td> <td><strong>{{$row->Progress}}</strong></td><td><strong>{{$row->Progress_7_15}}</strong></td><td><strong>{{$row->Progress_16_30}} </strong></td><td><strong>{{$row->Progress_30}} </strong></td><td><strong>{{$resolved}}</strong> </td>
   </tr>
