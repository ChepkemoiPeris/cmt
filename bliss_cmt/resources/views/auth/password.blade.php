            ...
            <div class="form-border">
                ...
                <div align="center">
                    ...
                    <h4 style="background-color: #18479D;"> <a href="http://www.faveohelpdesk.com" class="logo">
                        <a href="http://www.perzue.com" class="logo"><img src="{{ asset('company/Blisslogo.jpg')}}" width="100px;"></a>
                    </h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <span class="input-group-btn">
                                ...
                                <button type="submit" class="btn btn-default btn-block btn-flat" style="background-color:#18479D;color:#ffffff;">{!! Lang::get('lang.send') !!}</button>
                            </span>
                            <br/>
                        </div>
                    </div> 
