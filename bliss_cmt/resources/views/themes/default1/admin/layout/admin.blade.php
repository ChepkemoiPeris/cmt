...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .navbar-orange {background: #18479D;}
    ...
    <body class="skin-yellow sidebar-mini layout-fixed layout-navbar-fixed text-sm">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar elevation-4 sidebar-dark-orange">
                ...
                <a href="" class="brand-link navbar-orange" style="text-align: center; ">
                    <img src="{{asset('company/admin/Blisslogo.jpg')}}" height="100" width="90" class="brand-image" alt="Company Log0">
                </a>
