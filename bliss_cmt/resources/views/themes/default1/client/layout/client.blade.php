...
<html>
    <head>
        ...
        if (isset($title->name)) {
            ...
            $title_name = "Patient Management System";
        }
        ?>
            ...
            <header id="masthead" class="site-header" role="banner">
                ...
                <div class="container">
                    ...
                    <nav id="navbar" class="site-navigation navbar navbar-expand-lg navbar-light">
                        ...
                        <div id="logo" class="navbar-brand brand site-logo text-center" style="font-size: 30px;margin-left:-150px;"">
                            ...
                            @endif
                                ...
                                <img src="{{asset('company')}}{{'/'}}{{$company->logo}}" alt="User Image" style="margin-left:25px;" width="200px" height="200px"/>
                        ...
                        <div class="collapse navbar-collapse links" id="navbarSupportedContent">
                            ...
                            <div id="login-form" class="{{$loginFormClass}}">
                                 <div class="row">
                                    ...
                                    <div class="col-md-12" >
                                            <button type="submit" class="btn btn-custom" style="background-color:#18479D;">{!! Lang::get('lang.login') !!}</button>
                                        {!! Form::close() !!}
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="site-info col-md-6">
                            <p class="text-muted">{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}.   {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="https://www.blissmedicalcentre.com/"  target="_blank">Bliss Medical Centre</a></p>
                        </div>
