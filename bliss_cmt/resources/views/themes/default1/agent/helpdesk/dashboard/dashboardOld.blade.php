...
<div class="row">
	...
	<div class="col-md-3" style="max-width: 20%;">
		...
		<a href="{!! url('tickets') !!}" class="text-dark" style="cursor: pointer;">
	...
	<div class="col-md-3" style="max-width: 20%;">
		...
		<a href="{{url('/tickets?show=unassign')}}" class="text-dark" style="cursor: pointer;">
	...
	<div class="col-md-3" style="max-width: 20%;">
		...
		<a href="{{url('/tickets?show=overdue')}}" class="text-dark" style="cursor: pointer;">
			...
			<div class="info-box">
				...
				<span class="info-box-icon bg-danger"><i class="fas fa-calendar-times"></i></span>
			  	...
			  	<div class="info-box-content">
                   ...
                   @endphp
					<span class="info-box-number">{{ $ticket_overdue }}</span>
			  	</div>
			</div>
		</a>
	</div>
	...
	<div class="col-md-3" style="max-width: 20%;">
		...
		<a href="{{url('/tickets?show=mytickets')}}" class="text-dark" style="cursor: pointer;">
		...
		<?php
	  		if (Auth::user()->role == 'admin') {
				...
				$dept =  App\Model\helpdesk\Agent\Department::where('id', '=', Auth::user()->primary_dpt)->first();
	 			$todaytickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->whereDate('tickets.duedate','=', \Carbon\Carbon::now()->format('Y-m-d'))->where('dept_id', '=', isset($dept->id))->count();
				}
	  	?>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="description-block">
                    ...
                    <span>{!! Lang::get('lang.Total_Closed') !!}</span>
                    <p id="total_close"></p>
                </div>
...
<script type="text/javascript">
						$(document).ready(function () {
							$.getJSON("agen", function (result) {
								...
								$("#total_progress").html(open_total);
								$("#total_reopen").html(reopened_total);
								$("#total_close").html(closed_total);
