        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="btn-group">
                        <button type="button" href="#myPopup" data-rel="popup" class="btn btn-default btn-sm" data-toggle="modal" 
                            data-target="#addNewCategoryModal5">{{Lang::get('lang.change_role_to_agent1')}}</button>
                    </div>
                    @elseif($users->role == 'agent')
                    <div class="btn-group">
                        <button type="button" href="#myPopup" data-rel="popup" class="btn btn-default btn-sm" data-toggle="modal" 
...
//close autocomplite
  ...
  <!-- Agent1 -->
  <form action="{!!URL::route('user.post.rolechangeagent1', $users->id)!!}" method="post" role="form">
    {{ csrf_field() }}
        <div class="modal fade" id="addNewCategoryModal5" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
