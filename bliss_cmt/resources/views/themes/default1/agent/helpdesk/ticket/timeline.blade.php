...
<!--         <div class="mb-3">
            ...
            if (isset($group->can_edit_ticket) == 1) {
                ?>
            ...
            <?php if (isset($group->can_assign_ticket) == 1) { ?>
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  ...
                  @if(Auth::user()->role == 'admin')
                    ...
                    <?php if (isset($group->can_edit_ticket) == 1) {?>
                    <a href="#" id="close" class="dropdown-item"><i class="fas fa-check" style="color:green;"> </i> {!! Lang::get('lang.close') !!}</a>
                    <?php } ?>
                     <?php } ?>
            ...
            <?php if (isset($group->can_delete_ticket) == 1 || isset($group->can_ban_email) == 1) { ?>
       ...
       <?php
                                ...
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input type="hidden" id="email" name="To" class="form-control" style="width:55%" value="{{$user->email}}">
                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <h3 class="timeline-header">
                                            ...
                                            <span style="float: right;font-size: 12px;color: #999;margin: 4px;"><i class="far fa-clock"></i> {{date('d/m/Y h:i:s',strtotime($conversation->created_at))}}</span>
        ...
        ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr><td style="width: 30%">Member Type</td><td>{{$ticket_form_datas->member_type}}</td>
                                            </tr>

                                            <tr><td style="width: 30%">Patient Type</td><td>{{$ticket_form_datas->patient_type}}</td>
                                            </tr>
...
<div>
    ...
    <?php }
    ?>
<?php if (isset($group->can_ban_email) == 1) { ?>
        <!-- ban email modal -->
