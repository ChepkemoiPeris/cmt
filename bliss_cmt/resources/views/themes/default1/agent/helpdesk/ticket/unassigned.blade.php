...
if (Auth::user()->role == 'agent') {
    ...
    $tickets = App\Model\helpdesk\Ticket\Tickets::whereNull('assigned_to')->where('dept_id', '=', $dept->id)->where('status', '1')->orderBy('id', 'DESC')->count();
} else {
    $tickets = App\Model\helpdesk\Ticket\Tickets::whereNull('assigned_to')->where('status', '1')->orderBy('id', 'DESC')->count();
}
// dd($tickets);
?>
<!-- Main content -->
...
<div class="card card-light">
    <div class="card-header">
        <?php $counted = count(App\Model\helpdesk\Ticket\Tickets::whereNull('assigned_to')->get()); ?>
