    ...
    <head>
       ...
       <!-- Bootstrap 4.3.1 -->
        ...
        <style type="text/css">
            ...
            .navbar-lightblue {background: #18479D;}
    ...
    <body class="skin-yellow sidebar-mini layout-fixed layout-navbar-fixed text-sm">
        ...
        <div class="wrapper">
             ...
             <nav class="main-header navbar navbar-expand navbar-dark navbar-lightblue">
                ...
                <ul class="navbar-nav">
                  @if($auth_user_role == 'admin')
                    ...
                    @if($auth_user_role == 'admin')
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="#" data-toggle="tab" @yield('Tickets') class="nav-link" onclick="clickTickets(event);" id="ticket_tab">
                    ...
                    @if($auth_user_role == 'admin' || $auth_user_role == 'agent1')
                    <li class="nav-item d-none d-sm-inline-block">
                    ...
                    @if($auth_user_role == 'admin')
                   <li class="nav-item d-none d-sm-inline-block">
                        <a href="{{URL::route('esclation.matrix')}}" onclick="clickEsclation(event);"  @yield('Esclation') class="nav-link"  >
                            {!! Lang::get('lang.esclation') !!}
                        </a>
                    </li>
                    @endif
            ...
            <aside class="main-sidebar elevation-4 sidebar-dark-lightblue">
                ...
                <a  href="{{route('/')}}" class="brand-link navbar-lightblue" style="text-align: center;">
                    <img src="{{ asset('company/admin/Blisslogo.jpg')}}" height="100" width="90" class="brand-image" alt="Company Logo">
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                       ...
                       <div class="image">
                            ...
                            <img id="sidebar-profile-img" src="{{$auth_user_profile_pic}}" alt="User Image" width="auto" height="auto" 
                                class="img-circle " style="width: 60px;height: 30px;">
                        </div>
                        @endif
                       <div class="info">
                            @if($auth_user_id)
                    ...
                    <nav class="mt-2">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('tickets')}}" id="load-inbox" @yield('inbox') class="nav-link">
                                    ...
                                    <p>{!! Lang::get('lang.inbox') !!}</p> 
                                     @php
                                        $ticket_count = DB::table('tickets')->where('status',1)->count();
                                     @endphp
                                    <small class="right badge badge-success">{{$ticket_count}}</small>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                 <a href="{{url('/tickets?show=unassign')}}" id="load-unassigned" @yield('unassigned')  class="nav-link">
                            ...
                            <li class="nav-item">
                                 <a href="{{url('/tickets?show=overdue')}}" id="load-unassigned" @yield('overdue') class="nav-link">
                                    ...
                                    @php
                                        $ticket_overdue = DB::table('tickets')->whereNotNull('tickets.duedate')
                                                             ->where('status',1)   
                                    ...
                                    @endphp
                                    <small class="right badge badge-success">{{$ticket_overdue}}</small>
                                </a>
                            </li>
                    ...
                    <div @yield('ticket') class="tab-pane" id="tab_ticket">
                        ...
                        <nav class="navbar navbar-expand navbar-dark navbar-lightblue">
                          ...
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item d-none d-sm-inline-block">
                              <a href="{{ url('/create-ticket')}}" @yield('newticket') class="nav-link">{!! Lang::get('lang.create_ticket') !!}</a>
                            </li>
...
<?php \Event::fire('service.desk.agent.topsubbar', array()); ?>
            ...
            <footer class="main-footer">
                ...
                <span style="font-weight: 500">{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}" target="_blank">{!! $company->company_name !!}</a>.</span> {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="https://www.blissmedicalcentre.com/" target="_blank">Bliss Medical Centre</a>
            </footer>
        </div><!-- ./wrapper -->
        ...
        <script type="text/javascript">
              ...
              function clickDashboard(e) {
                ...
                function clickEsclation(e) {
                    if (e.ctrlKey === true) {
                    window.open('{{URL::route("esclation.matrix")}}', '_blank');
                    } else {
                    window.location = "{{URL::route('esclation.matrix')}}";
                    }
                    }
