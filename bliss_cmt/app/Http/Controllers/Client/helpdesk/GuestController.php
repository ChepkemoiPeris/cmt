    ...
    public function getMyticket()
    {
        $user_id = Auth::user()->id;
         $search = \DB::table('tickets')
                ...
                'tickets.priority_id','cr.mobile_no','cr.service','cr.service_issue','cr.client_name','s.service_name','ts.name','users.mobile','tp.priority',
        ...
        return view('themes.default1.client.helpdesk.mytickets',compact('search'));
    }
