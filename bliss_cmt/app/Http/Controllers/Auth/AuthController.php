...
class AuthController extends Controller
{
     ...
     * @return type Response
     */
    public function postRegister(User $user, RegisterRequest $request,$api=null)
    {
        ...
        try {
            ...
            $user['name'] = $name;
            $user['subject']="Registration";
            $data['content'] ='Click on Button activate our account';
            $data['name']  = $name;
            $data['password_reset_link'] = url('account/activate/'.$code);


         Mail::send('register_email',$data, function ($m) use ($user) {
